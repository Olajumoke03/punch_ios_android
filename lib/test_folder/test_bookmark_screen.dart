...
class TestBookMarkScreen extends StatefulWidget {
  const TestBookMarkScreen({Key? key}) : super(key: key);

  @override
  State<TestBookMarkScreen> createState() => _TestBookMarkScreenState();
}

class _TestBookMarkScreenState extends State<TestBookMarkScreen> {
  late List bookmarks;
